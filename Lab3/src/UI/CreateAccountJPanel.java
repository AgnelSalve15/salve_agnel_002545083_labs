...
public class CreateAccountJPanel extends JPanel {
    ...
    private void initComponents() {
        ...
        gbc.gridx = 0; gbc.gridy = 5; gbc.gridwidth = 2; gbc.insets = new Insets(20, 0, 0, 0);
    ...
    private void btnSaveActionPerformed(java.awt.event.ActionEvent evt) {
        try {
            ...
            JOptionPane.showMessageDialog(this, "Please enter a valid balance amount.", "Error", JOptionPane.ERROR_MESSAGE);
        }
    }
